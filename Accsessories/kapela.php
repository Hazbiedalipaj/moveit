    ...
    <table>
        <tr>
            <td>
                ...
                <img src="icons/Καπελα/Nike4.jpg" style="width:260px;height:260px;" />
            </td>
            <td>

                <img src="icons/Καπελα/Adidas3.jpg" style="width:260px;height:260px;" />
            </td>
            <td>
                <img src="icons/Καπελα/Puma3.jpg" style="width:260px;height:200px;" />
            </td>
        </tr>
        ...
        <tr>
            <td><?php
                ...
                $sql = "SELECT*FROM kapela WHERE id=1";
            ...
            <td><?php
                ...
                $sql = "SELECT*FROM kapela WHERE id=2";
                $result = $conn->query($sql);
                if ($result->num_rows > 0) {
                // output data of each row
                while($row = $result->fetch_assoc()) {
            ...
            <td><?php
                ...
                $sql = "SELECT*FROM kapela WHERE id=3";
                $result = $conn->query($sql);
                if ($result->num_rows > 0) {
                // output data of each row
                while($row = $result->fetch_assoc()) {
