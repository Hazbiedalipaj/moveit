...
<body>
    ...
    <table>
        <tr>
            <td>
                <img src="icons/Ρολόι/Nike1.jpg" style="width:200px;height:200px;" />
            </td>

            <td>
                <img src="icons/Ρολόι/Adidas2.jpg" style="width:260px;height:230px;" />
            </td>

            <td>
                <img src="icons/Ρολόι/Puma2.png" style="width:260px;height:230px;" />
            </td>

            <td>
                <img src="icons/Ρολόι/Reebok1.jpg" style="width:260px;height:230px;" />
            </td>
        </tr>
        <tr>
            <td><?php
                ...
                $sql = "SELECT*FROM roloi WHERE id=1";
            ...
            <td><?php
                ...
                $sql = "SELECT*FROM roloi WHERE id=2";
                $result = $conn->query($sql);
                if ($result->num_rows > 0) {
                // output data of each row
                while($row = $result->fetch_assoc()) {
            ...
            <td><?php
                ...
                $sql = "SELECT*FROM roloi WHERE id=3";
                $result = $conn->query($sql);
                if ($result->num_rows > 0) {
                // output data of each row
                while($row = $result->fetch_assoc()) {
            ...
            <td><?php
                ...
                $sql = "SELECT*FROM roloi WHERE id=4";
                $result = $conn->query($sql);
                if ($result->num_rows > 0) {
                // output data of each row
                while($row = $result->fetch_assoc()) {
