...
<body>
    ...
    <div class="navbar">
        ...
        <div class="dropdown">
            ...
            <div class="dropdown-content">
                <a href="akoustika.php">Ακουστικά</a>
                <a href="kapela.php">Καπέλα</a>
                <a href="tsandes.php">Τσάντες</a>
                <a href="roloi.php">Ρολόι</a>
            </div>
        </div>
        <div class="dropdown">
            <button class="dropbtn">
    ...
    <table>
        <tr>
            <td>
                <img src="icons/Ακουστικά/akoustika hp(48).jpg" />

            </td>
            <td>
                <img src="icons/Ακουστικά/akoustika huawei(14,99).jpg" />

            </td>

            <td>
                <img src="icons/Ακουστικά/akoustika nokia(49,98).jpg" />
            </td>
        </tr>
        ...
        $sql = "SELECT*FROM akoustika WHERE id=3";
        ...
        $sql = "SELECT*FROM akoustika WHERE id=4";
        $result = $conn->query($sql);
        if ($result->num_rows > 0) {
        // output data of each row
        while($row = $result->fetch_assoc()) {
        ...
        $sql = "SELECT*FROM akoustika WHERE id=2";
        $result = $conn->query($sql);
        if ($result->num_rows > 0) {
        // output data of each row
        while($row = $result->fetch_assoc()) {
    ...
    <table>
        <tr>
            <td>
                ...
                <img src="icons/Ακουστικά/akoustika panasonic(15,98).jpg" />

            </td>
            <td>

                <img src="icons/Ακουστικά/akoustika samsung(18,98).jpg" />

            </td>
            <td>
                <img src="icons/Ακουστικά/akoustika sennheiser (59).jpg" />
            </td>
			            <td>

                <img src="icons/Ακουστικά/akoustika iluv (9,78).jpg" />
        ...
        <tr>
            <td><?php
                ...
                $sql = "SELECT*FROM akoustika WHERE id=6";
                $result = $conn->query($sql);
                if ($result->num_rows > 0) {
                // output data of each row
                while($row = $result->fetch_assoc()) {
            ...
            <td><?php
                ...
                $sql = "SELECT*FROM akoustika WHERE id=1";
                $result = $conn->query($sql);
                if ($result->num_rows > 0) {
                // output data of each row
                while($row = $result->fetch_assoc()) {
            ...
            <td><?php
                ...
                $sql = "SELECT*FROM akoustika WHERE id=7";
                $result = $conn->query($sql);
                if ($result->num_rows > 0) {
                // output data of each row
                while($row = $result->fetch_assoc()) {
...
<td><?php
        ...
        $sql = "SELECT*FROM akoustika WHERE id=5";
        $result = $conn->query($sql);
        if ($result->num_rows > 0) {
        // output data of each row
        while($row = $result->fetch_assoc()) {
