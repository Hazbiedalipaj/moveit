...
<body>
    ...
    <table>
        <tr>
            <td>
                <img src="icons/Τσάντες/nike(13,90).jpeg" style="width:260px;height:260px;" />
            </td>
            <td>
                <img src="icons/Τσάντες/adidas(15,09).jpeg" style="width:180px;height:260px;" />
            </td>
            <td>
                <img src="icons/Τσάντες/puma(22,48).jpeg" style="width:260px;height:260px;" />
            </td>
            <td>
                <img src="icons/Τσάντες/reebok(18,36).jpeg" style="width:260px;height:260px;" />
            </td>
        </tr>
        <tr>
            <td><?php
                ...
                $sql = "SELECT*FROM tsantes WHERE id=1";
            ...
            <td><?php
                ...
                $sql = "SELECT*FROM tsantes WHERE id=2";
                $result = $conn->query($sql);
                if ($result->num_rows > 0) {
                // output data of each row
                while($row = $result->fetch_assoc()) {
            ...
            <td><?php
                ...
                $sql = "SELECT*FROM tsantes WHERE id=3";
                $result = $conn->query($sql);
                if ($result->num_rows > 0) {
                // output data of each row
                while($row = $result->fetch_assoc()) {
            ...
            <td><?php
                ...
                $sql = "SELECT*FROM tsantes WHERE id=4";
                $result = $conn->query($sql);
                if ($result->num_rows > 0) {
                // output data of each row
                while($row = $result->fetch_assoc()) {
