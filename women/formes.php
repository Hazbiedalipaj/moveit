...
<body>
    ...
    <table>
        <tr>
            <td>
                <img src="icons/Φορμες Γ/Nike1.1.jpg" style="width:280px;height:220px;" />
            </td>
            <td>
                <img src="icons/Φορμες Γ/Adidas1.1.jpg" style="width:280px;height:230px;" />
            </td>
            <td>
                <img src="icons/Φορμες Γ/Puma2.jpg" style="width:280px;height:230px;" />
            </td>
        </tr>
        ...
        <tr>
            <td><?php
                ...
                $sql = "SELECT*FROM formesg WHERE id=1";
            ...
            <td><?php
                ...
                $sql = "SELECT*FROM formesg WHERE id=2";
                $result = $conn->query($sql);
                if ($result->num_rows > 0) {
                // output data of each row
                while($row = $result->fetch_assoc()) {
            ...
            <td><?php
                ...
                $sql = "SELECT*FROM formesg WHERE id=3";
                $result = $conn->query($sql);
                if ($result->num_rows > 0) {
                // output data of each row
                while($row = $result->fetch_assoc()) {
        ...
        <tr>
            <td>
                <img src="icons/Φορμες Γ/Under Armaor1.jpg" style="width:280px;height:220px;" />
            </td>
            <td>
                <img src="icons/Φορμες Γ/Reebok1.jpg" style="width:280px;height:220px;" />
            </td>
            <td>
                <img src="icons/Φορμες Γ/Everlast4.jpg" style="width:280px;height:220px;" />
            </td>
        ...
        <tr>
            <td><?php
                ...
                $sql = "SELECT*FROM formesg WHERE id=4";
                $result = $conn->query($sql);
                if ($result->num_rows > 0) {
                // output data of each row
                while($row = $result->fetch_assoc()) {
            ...
            <td><?php
                ...
                $sql = "SELECT*FROM formesg WHERE id=5";
                $result = $conn->query($sql);
                if ($result->num_rows > 0) {
                // output data of each row
                while($row = $result->fetch_assoc()) {
            ...
            <td><?php
                ...
                $sql = "SELECT*FROM formesg WHERE id=6";
                $result = $conn->query($sql);
                if ($result->num_rows > 0) {
                // output data of each row
                while($row = $result->fetch_assoc()) {
