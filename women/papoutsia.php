    ...
    <script>
        function run() {
            ...
            if (ln == "" || ln == NULL) {
                ...
                alert("Συγχαρητήρια!! Πλέον μπορείτε να ενημερωθείτε πρώτοι για τις νέες μας παραλαβές!!");
                return true
            }
        }
    </script>
...
<body>
    ...
    <table>
        <tr>
            <td>
                <img src="icons/Παπουτσια Γ/Nike2.jpg" style="width:280px;height:280px;" />
            </td>
            <td>
                <img src="icons/Παπουτσια Γ/Adidas1.jpg" style="width:280px;height:210px;" />
            </td>
            <td>
                <img src="icons/Παπουτσια Γ/Puma3.jpg" style="width:280px;height:210px;" />
            </td>
            <td>
                <img src="icons/Παπουτσια Γ/Under Armour2.jpg" style="width:280px;height:250px;" />
            </td>
        </tr>
        ...
        <tr>
            <td><?php
                ...
                $sql = "SELECT*FROM papoutsiag WHERE id=1";
            ...
            <td><?php
                ...
                $sql = "SELECT*FROM papoutsiag WHERE id=2";
                $result = $conn->query($sql);
                if ($result->num_rows > 0) {
                // output data of each row
                while($row = $result->fetch_assoc()) {
            ...
            <td><?php
                ...
                $sql = "SELECT*FROM papoutsiag WHERE id=3";
                $result = $conn->query($sql);
                if ($result->num_rows > 0) {
                // output data of each row
                while($row = $result->fetch_assoc()) {
            ...
            <td><?php
                ...
                $sql = "SELECT*FROM papoutsiag WHERE id=4";
                $result = $conn->query($sql);
                if ($result->num_rows > 0) {
                // output data of each row
                while($row = $result->fetch_assoc()) {
        ...
        <tr>
            <td>
                ...
                <img src="icons/Παπουτσια Γ/Reebok1.jpg" style="width:300px;height:200px;" />
            </td>
            <td>
                <img src="icons/Παπουτσια Γ/Everlast2.jpg" style="width:280px;height:250px;" />
            </td>
            <td>
                <img src="icons/Παπουτσια Γ/Slazenger2.jpeg" style="width:300px;height:160px;" />
            </td>
        ...
        <tr>
            <td><?php
                ...
                $sql = "SELECT*FROM papoutsiag WHERE id=5";
                $result = $conn->query($sql);
                if ($result->num_rows > 0) {
                // output data of each row
                while($row = $result->fetch_assoc()) {
            ...
            <td><?php
                ...
                $sql = "SELECT*FROM papoutsiag WHERE id=6";
                $result = $conn->query($sql);
                if ($result->num_rows > 0) {
                // output data of each row
                while($row = $result->fetch_assoc()) {
            ...
            <td><?php
                ...
                $sql = "SELECT*FROM papoutsiag WHERE id=7";
                $result = $conn->query($sql);
                if ($result->num_rows > 0) {
                // output data of each row
                while($row = $result->fetch_assoc()) {
