...
<body>
    ...
    <table>
        <tr>
            <td>
                <img src="icons/Ζακετες Γ/Nike8.jpg" style="width:220px;height:260px;" />
            </td>
            <td>
                <img src="icons/Ζακετες Γ/Adidas2.jpg" style="width:260px;height:280px;" />
            </td>
            <td>
                <img src="icons/Ζακετες Γ/Puma2.jpeg" style="width:230px;height:268px;" />
            </td>
        </tr>
        ...
        <tr>
            <td><?php
                ...
                $sql = "SELECT*FROM zaketesg WHERE id=1";
            ...
            <td><?php
                ...
                $sql = "SELECT*FROM zaketesg WHERE id=2";
                $result = $conn->query($sql);
                if ($result->num_rows > 0) {
                // output data of each row
                while($row = $result->fetch_assoc()) {
            ...
            <td><?php
                ...
                $sql = "SELECT*FROM zaketesg WHERE id=3";
                $result = $conn->query($sql);
                if ($result->num_rows > 0) {
                // output data of each row
                while($row = $result->fetch_assoc()) {
        ...
        <tr>
            <td>
                <img src="icons/Ζακετες Γ/Reebok3.jpg" style="width:300px;height:300px;" />
            </td>
            <td>
                <img src="icons/Ζακετες Γ/Everlast1.jpg" style="width:220px;height:260px;" />
            </td>
        </tr>
        <tr>
            <td><?php
                ...
                $sql = "SELECT*FROM zaketesg WHERE id=4";
                $result = $conn->query($sql);
                if ($result->num_rows > 0) {
                // output data of each row
                while($row = $result->fetch_assoc()) {
            ...
            <td><?php
                ...
                $sql = "SELECT*FROM zaketesg WHERE id=5";
                $result = $conn->query($sql);
                if ($result->num_rows > 0) {
                // output data of each row
                while($row = $result->fetch_assoc()) {
