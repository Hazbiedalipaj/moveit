...
<body>
    ...
    <table>
        <tr>
            <td>
                <img src="icons/Μπλουζες Γ/Nike1.jpg" style="width:260px;height:260px;" />
            </td>
            <td>
                <img src="icons/Μπλουζες Γ/Puma2.jpeg" style="width:140px;height:240px;" />
            </td>
            <td>
                <img src="icons/Μπλουζες Γ/Adidas1.jpg" style="width:280px;height:270px;" />
            </td>
        </tr>
        ...
        <tr>
            <td><?php
                ...
                $sql = "SELECT*FROM mplouzesg WHERE id=1";
            ...
            <td><?php
                ...
                $sql = "SELECT*FROM mplouzesg WHERE id=2";
                $result = $conn->query($sql);
                if ($result->num_rows > 0) {
                // output data of each row
                while($row = $result->fetch_assoc()) {
            ...
            <td><?php
                ...
                $sql = "SELECT*FROM mplouzesg WHERE id=3";
                $result = $conn->query($sql);
                if ($result->num_rows > 0) {
                // output data of each row
                while($row = $result->fetch_assoc()) {
        ...
        <tr>
            <td>
                <img src="icons/Μπλουζες Γ/Under Armour2.jpeg" style="width:220px;height:260px;" />
            </td>
            <td>
                <img src="icons/Μπλουζες Γ/Reebok1.jpg" style="width:290px;height:290px;" />
            </td>
            <td>
                <img src="icons/Μπλουζες Γ/Everlast2.jpg" style="width:200px;height:240px;" />
            </td>
        ...
        <tr>
            <td><?php
                ...
                $sql = "SELECT*FROM mplouzesg WHERE id=4";
                $result = $conn->query($sql);
                if ($result->num_rows > 0) {
                // output data of each row
                while($row = $result->fetch_assoc()) {
            ...
            <td><?php
                ...
                $sql = "SELECT*FROM mplouzesg WHERE id=5";
                $result = $conn->query($sql);
                if ($result->num_rows > 0) {
                // output data of each row
                while($row = $result->fetch_assoc()) {
            ...
            <td><?php
                ...
                $sql = "SELECT*FROM mplouzesg WHERE id=6";
                $result = $conn->query($sql);
                if ($result->num_rows > 0) {
                // output data of each row
                while($row = $result->fetch_assoc()) {
