...
<body>
    ...
    <table>
        <tr>
            <td>
                <img src="icons/Ζακετες Α/Nike1.jpeg" style="width:220px;height:260px;" />
            </td>
            <td>
                <img src="icons/Ζακετες Α/Adidas1.jpeg" style="width:260px;height:260px;" />
            </td>
            <td>
                <img src="icons/Ζακετες Α/Puma1.jpeg" style="width:260px;height:260px;" />
            </td>
            <td>
                <img src="icons/Ζακετες Α/Everlast1.jpeg" style="width:260px;height:260px;" />
            </td>
        </tr>
        <tr>
            <td>
                ...
                $sql = "SELECT*FROM zaketesa WHERE id=1";
            ...
            <td>
                ...
                $sql = "SELECT*FROM zaketesa WHERE id=2";
                $result = $conn->query($sql);
                if ($result->num_rows > 0) {
                // output data of each row
                while($row = $result->fetch_assoc()) {
            ...
            <td>
                ...
                $sql = "SELECT*FROM zaketesa WHERE id=3";
                $result = $conn->query($sql);
                if ($result->num_rows > 0) {
                // output data of each row
                while($row = $result->fetch_assoc()) {
            ...
            <td>
                ...
                $sql = "SELECT*FROM zaketesa WHERE id=4";
                $result = $conn->query($sql);
                if ($result->num_rows > 0) {
                // output data of each row
                while($row = $result->fetch_assoc()) {
