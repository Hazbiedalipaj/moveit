...
<body>
    ...
    <table>
        <tr>
            <td>
                <img src="icons/Μπλουζες Α/Nike2.jpg" style="width:260px;height:260px;" />
            </td>
            <td>
                <img src="icons/Μπλουζες Α/Adidas1.jpeg" style="width:230px;height:260px;" />
            </td>
            <td>
                <img src="icons/Μπλουζες Α/Under Armour3.jpg" style="width:260px;height:260px;" />
            </td>
        </tr>
        <tr>
            <td><?php
                ...
                $sql = "SELECT*FROM mplouzesa WHERE id=1";
            ...
            <td><?php
                ...
                $sql = "SELECT*FROM mplouzesa WHERE id=2";
                $result = $conn->query($sql);
                if ($result->num_rows > 0) {
                // output data of each row
                while($row = $result->fetch_assoc()) {
            ...
            <td><?php
                ...
                $sql = "SELECT*FROM mplouzesa WHERE id=3";
                $result = $conn->query($sql);
                if ($result->num_rows > 0) {
                // output data of each row
                while($row = $result->fetch_assoc()) {
