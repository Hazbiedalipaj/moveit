...
<body>
    ...
    <table>
        <tr>
            <td>
                <img src="icons/Παπουτσια Α/Nike1.jpg" style="width:260px;height:180px;" />
            </td>
            <td>
                <img src="icons/Παπουτσια Α/Adidas3.jpg" style="width:280px;height:280px;" />
            </td>
            <td>
                <img src="icons/Παπουτσια Α/Puma1.jpg" style="width:260px;height:260px;" />
            </td>
        </tr>
        <tr>
            <td><?php
                ...
                $sql = "SELECT*FROM papoutsiaa WHERE id=1";
            ...
            <td><?php
                ...
                $sql = "SELECT*FROM papoutsiaa WHERE id=2";
                $result = $conn->query($sql);
                if ($result->num_rows > 0) {
                // output data of each row
                while($row = $result->fetch_assoc()) {
            ...
            <td><?php
                ...
                $sql = "SELECT*FROM papoutsiaa WHERE id=3";
                $result = $conn->query($sql);
                if ($result->num_rows > 0) {
                // output data of each row
                while($row = $result->fetch_assoc()) {
